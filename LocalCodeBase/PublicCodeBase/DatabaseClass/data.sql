-- Data for final project phase 3

INSERT INTO staff (staffid, role, staffname, supervisorid) VALUES
(1, 'Administrator', 'Alice Johnson', NULL),
(2, 'Nurse', 'Bob Smith', 5),
(3, 'Receptionist', 'Cathy Brown', NULL);
(4, 'Technician', 'David Wilson', NULL);
(5, 'Doctor', 'Eve Davis', 6);
(6, 'Doctor', 'Frank Miller', 7);
(7, 'Doctor', 'Grace Lee', NULL);
(8, 'Nurse', 'Hannah Taylor', 6);
(9, 'Nurse', 'Ian Clark', 7);
(10, "Pharmacist", 'Jack Lewis', NULL);
(11, 'Doctor', 'Alice Smith', 7);
...
(1009, 'R3344556', 'Oncology', '310-555-9988', 'icalrk@newmilleniamed.com', 'Ian', 'Clark', NULL),
...
('PT1001', 'John', 'A.', 'Doe', 'M', 98101, 'WA', 'Seattle', '123 Maple St', '1980-05-15', 'P123456789'),
('PT1002', 'Jane', 'B.', 'Smith', 'F', 90210, 'CA', 'Beverly Hills', '456 Oak St', '1990-07-22', 'P987654321'),
('PT1003', 'Emily', NULL, 'Johnson', 'F', 60614, 'IL', 'Chicago', '789 Pine St', '1975-03-30', 'P456789123'),
('PT1004', 'Michael', 'C.', 'Brown', 'M', 10001, 'NY', 'New York', '321 Cedar St', '1985-11-05', 'P654321987'),
('PT1005', 'Sarah', NULL, 'Davis', 'F', 73301, 'TX', 'Austin', '654 Spruce St', '1992-09-12', 'P789123456'),
('PT1006', 'David', 'D.', 'Wilson', 'M', 33101, 'FL', 'Miami', '987 Birch St', '1978-12-25', 'P321987654'),
('PT1007', 'Laura', NULL, 'Garcia', 'F', 85001, 'AZ', 'Phoenix', '147 Elm St', '1983-04-18', 'P876543210'),
('PT1008', 'James', 'E.', 'Martinez', 'M', 75201, 'TX', 'Dallas', '258 Willow St', '1995-06-09', 'P234567890'),
('PT1009', 'Olivia', NULL, 'Rodriguez', 'F', 94101, 'CA', 'San Francisco', '369 Chestnut St', '1988-10-30', 'P765432109'),
('PT1010', 'Daniel", "F.", "Hernandez", "M", 48201, "MI", "Detroit", "159 Poplar St", "1972-02-14", "P109876543'),
('PT1011', 'Sophia', 'G.', 'Lopez', 'F', 30301, 'GA', 'Atlanta', '753 Cypress St', '1993-08-27', 'P123456788');
...
(5011, '2024-11-25', 'Paid', 770.20, 'PT1011');
...
(2011, 'Annual physical exam with comprehensive health screening.', 190.00, 'A1011');
...
(3011, 1001, 'PT1011', 'A1011', 'Levothyroxine', '2024-06-11', '2025-06-11', '75mcg once daily');
...
('PT1002', 'jane.smith02@example.com'),
('PT1002', 'jane.smith@example.com'),
('PT1003', 'emily.johnson@example.com'),
('PT1004', 'michael.brown@example.com'),
('PT1005', 'sarah.davis@example.com'),
('PT1006', 'david.wilson@example.com'),
('PT1007', 'laura.garcia@example.com'),
('PT1008', 'james.martinez@example.com'),
('PT1009', 'olivia.rodriguez@example.com'),
('PT1010', 'daniel.hernandez@example.com'),
('PT1011', 'sophia.lopez@example.com');